  ...
  "inline-flex items-center justify-center gap-2 whitespace-nowrap text-sm font-medium transition-all focus-visible:outline-none focus-visible:ring-1 focus-visible:ring-ring disabled:pointer-events-none disabled:opacity-50 [&_svg]:pointer-events-none [&_svg]:size-4 [&_svg]:shrink-0",
  {
    variants: {
      variant: {
        ...
        neon: "bg-neon-acid text-void font-display italic uppercase tracking-wider hover:translate-x-0.5 hover:-translate-y-0.5 shadow-[4px_4px_0px_0px_rgba(255,255,255,0.2)] active:translate-x-0 active:translate-y-0",
        neonOutline: "border-2 border-neon-cyan text-neon-cyan font-display italic uppercase tracking-wider hover:bg-neon-cyan/10",
      },
      size: {
